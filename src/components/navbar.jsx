...
function Navbar() {
  ...
  return (
    <div className="flex flex-row justify-between h-20 items-center px-20 bg-teal-600">
      ...
      <div className="flex flex-row gap-3">
        ...
        >
          <div className="relative flex flex-col overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-teal-500 ring-0 ring-gray-300 hover:ring-8 group-focus:ring-4 ring-opacity-30 duration-200 shadow-md">
